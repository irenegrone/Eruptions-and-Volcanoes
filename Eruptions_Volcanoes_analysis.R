...
holocene_volcanoes <- read_xlsx(Holocene_FILE_PATH, sheet = "Holocene Volcano List", skip = 1)

# Volcano list Pleistocene
pleistocene_volcanoes <- read_xlsx(Pleistocene_FILE_PATH, sheet = "Pleistocene Volcano List", skip = 1)
